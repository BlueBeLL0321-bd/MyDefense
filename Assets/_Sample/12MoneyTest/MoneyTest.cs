...
3. 버튼 3개
1) 저축 버튼 : 1000 저축, 버튼 클릭 시 +1000, "1000 Gold Save" 출력
2) 구매 버튼 : 1000원 아이템 구매, 버튼 클릭 시 -1000, "1000 Item Purchase" 출력
3) 구매 버튼 : 9000원 아이템 구매, 버튼 클릭 시 -9000, "9000 Item Purchase" 출력
