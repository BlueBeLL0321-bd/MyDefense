...
namespace Sample
{
    ...
    public class MoneyTest : MonoBehaviour
    {
        ...
        // 버튼 3개 클릭 시 호출되는 함수 3개 만들고 각 버튼에 연결
        // 버튼 클릭 시 Gold 계산하고 출력하세요
        public void CheonSave()
        {
            AddGold(1000);
        }

        public void CheonPurchase()
        {
...
3. 버튼 3개
1) 저축 버튼 : 1000 저축, 버튼 클릭 시 +1000, "1000 Gold Save" 출력 - gold Save
2) 구매 버튼 : 1000원 아이템 구매, 버튼 클릭 시 -1000, "1000 Item Purchase" 출력 - gold Save
3) 구매 버튼 : 9000원 아이템 구매, 버튼 클릭 시 -9000, "9000 Item Purchase" 출력 - gold Save
